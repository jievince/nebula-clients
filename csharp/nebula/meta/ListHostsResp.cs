...
namespace nebula.meta
{
  ...
  public partial class ListHostsResp : TBase
  {
        ...
        switch (field.ID)
        {
          ...
          case 3:
            if (field.Type == TType.List) {
              {
                this.hosts = new List<HostItem>();
                TList _list62 = iprot.ReadListBegin();
                for( int _i63 = 0; _i63 < _list62.Count; ++_i63)
                {
                  HostItem _elem64 = new HostItem();
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("ListHostsResp");
      ...
      if (this.hosts != null && __isset.hosts) {
        ...
        oprot.WriteFieldBegin(field);
        {
          oprot.WriteListBegin(new TList(TType.Struct, this.hosts.Count));
          foreach (HostItem _iter65 in this.hosts)
          {
            _iter65.Write(oprot);
            oprot.WriteListEnd();
          }
